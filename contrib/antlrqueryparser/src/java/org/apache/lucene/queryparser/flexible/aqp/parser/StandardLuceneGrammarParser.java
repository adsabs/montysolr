// $ANTLR 3.4 /dvt/workspace/montysolr/contrib/antlrqueryparser/grammars/StandardLuceneGrammar.g 2012-07-31 16:06:26
        ...
        try {
            ...
            switch (alt21) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: value, field, modifier, term_modifier
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
