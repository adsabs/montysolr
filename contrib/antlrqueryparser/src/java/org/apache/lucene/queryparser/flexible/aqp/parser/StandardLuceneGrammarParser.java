// $ANTLR 3.4 /dvt/workspace/montysolr/contrib/antlrqueryparser/grammars/StandardLuceneGrammar.g 2012-10-29 16:16:14
        ...
        try {
            ...
            switch (alt21) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: modifier, multi_value, term_modifier, field
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
