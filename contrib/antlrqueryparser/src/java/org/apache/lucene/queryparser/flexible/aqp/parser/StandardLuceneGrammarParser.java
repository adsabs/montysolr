// $ANTLR 3.4 /dvt/workspace/montysolr/contrib/antlrqueryparser/grammars/StandardLuceneGrammar.g 2012-11-21 14:08:23
        ...
        try {
            ...
            switch (alt21) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: field, modifier, term_modifier, multi_value
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
