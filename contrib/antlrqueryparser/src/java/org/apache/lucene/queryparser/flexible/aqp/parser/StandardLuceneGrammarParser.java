// $ANTLR 3.4 /dvt/workspace/montysolr/contrib/antlrqueryparser/grammars/StandardLuceneGrammar.g 2013-01-31 18:09:21
        ...
        try {
            ...
            switch (alt21) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: term_modifier, multi_value, field, modifier
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
