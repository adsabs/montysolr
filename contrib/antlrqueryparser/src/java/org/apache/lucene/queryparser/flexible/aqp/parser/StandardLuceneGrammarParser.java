// $ANTLR 3.4 /dvt/workspace/montysolr/contrib/antlrqueryparser/grammars/StandardLuceneGrammar.g 2012-07-31 17:16:02
        ...
        try {
            ...
            switch (alt21) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: value, term_modifier, field, modifier
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
