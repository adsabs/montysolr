...
public abstract class AqpSyntaxParserImpl extends AqpSyntaxParserAbstract implements AqpSyntaxParser {
	...
	public AqpSyntaxParser initializeGrammar(String grammarName) throws QueryNodeParseException {
		...
		try {
		// get the Classes
        clsLexer = Class.forName("org.apache.lucene.queryparser.flexible.aqp.parser." + grammarName + "Lexer");
        clsParser = Class.forName("org.apache.lucene.queryparser.flexible.aqp.parser." + grammarName + "Parser");
