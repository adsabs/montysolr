// $ANTLR 3.4 /dvt/workspace/montysolr/contrib/invenio/grammars/Invenio.g 2013-01-31 18:09:51
        ...
        try {
            ...
            switch (alt16) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: value, field, term_modifier, modifier
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
