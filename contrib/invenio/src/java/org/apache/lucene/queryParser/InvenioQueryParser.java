/* Generated By:JavaCC: Do not edit this line. InvenioQueryParser.java */
 ...
 *
 * <p>
 * In {@link TermRangeQuery}s, InvenioQueryParser tries to detect date values, e.g.
 ...
 * query parser that inherits InvenioQueryParser and overwrites
 * {@link #getRangeQuery(String, String, String, boolean)} to
 * use a different method for date conversion.
 * </p>
 *
 * <p>Note that InvenioQueryParser is <em>not</em> thread-safe.</p>
 *
 * <p><b>NOTE</b>: there is a new InvenioQueryParser in contrib, which matches
 * the same syntax as this class, but is more modular,
 * enabling substantial customization to how a query is created.
 *
 * <a name="version"/>
 * <p><b>NOTE</b>: You must specify the required {@link Version}
 * compatibility when creating InvenioQueryParser:
 * <ul>
 *    <li> As of 2.9, {@link #setEnablePositionIncrements} is true by
 *         default.
 * </ul>
 */
public class InvenioQueryParser implements InvenioQueryParserConstants {
  ...
  private static final int MOD_SECOND  = 12;

  // make it possible to call setDefaultOperator() without accessing
  // the nested class:
  /** Alternative form of InvenioQueryParser.Operator.AND */
  public static final Operator AND_OPERATOR = Operator.AND;
  /** Alternative form of InvenioQueryParser.Operator.OR */
   ...
   * Use {@link InvenioQueryParser#setDefaultOperator} to change it.
   */
   ...
   *  @deprecated Use {@link #InvenioQueryParser(Version, String, Analyzer)} instead
   */
  public InvenioQueryParser(String f, Analyzer a) {
   ...
   *  @param a   used to find terms in the query text.
   */
  public InvenioQueryParser(Version matchVersion, String f, Analyzer a) {
  ...
  /**
   * Sets the boolean operator of the InvenioQueryParser.
  ...
  /**
   * By default InvenioQueryParser uses {@link MultiTermQuery#CONSTANT_SCORE_AUTO_REWRITE_DEFAULT}
  ...
  */
  ...
  /**
   * Returns a String where those characters that InvenioQueryParser
  ...
  /**
   * Command line tool to test InvenioQueryParser, using {@link org.apache.lucene.analysis.SimpleAnalyzer}.
   * Usage:<br>
   * <code>java org.apache.lucene.queryParser.InvenioQueryParser &lt;input&gt;</code>
   */
  public static void main(String[] args) throws Exception {
    if (args.length == 0) {
      System.out.println("Usage: java org.apache.lucene.queryParser.InvenioQueryParser <input>");
      System.exit(0);
    }
    InvenioQueryParser qp = new InvenioQueryParser(Version.LUCENE_CURRENT, "field",
...
// This makes sure that there is no garbage after the query string
  ...
  Query q;
    ...
    case NUMBER:
      ...
      case NUMBER:
        ...
        break;
      case REGEX_TERM:
        term = jj_consume_token(REGEX_TERM);
        break;
      default:
        jj_la1[8] = jj_gen;
        jj_consume_token(-1);
    ...
    case QUOTED:
      ...
      break;
    case QUOTED_PARTIAL:
      term = jj_consume_token(QUOTED_PARTIAL);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case FUZZY_SLOP:
        fuzzySlop = jj_consume_token(FUZZY_SLOP);
        break;
      ...
      default:
        ...
        ;
         ...
         if (fuzzySlop != null) {
           try {
             partialSlop = Float.valueOf(fuzzySlop.image.substring(1)).intValue();
           }
           catch (Exception ignored) {
             partialSlop = 2;
           }
         }
         q = getFieldQuery(field, discardEscapeChar(term.image.substring(1, term.image.length()-1)), partialSlop);
      break;
    default:
      jj_la1[24] = jj_gen;
      jj_consume_token(-1);
  ...
  public InvenioQueryParserTokenManager token_source;
  /** Current token. */
  public Token token;
  /** Next token. */
  public Token jj_nt;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xc00,0xc00,0x7000,0x7000,0x3f74fc00,0x440000,0x80000,0x3f748000,0x33440000,0x800000,0x800000,0x80000,0x0,0x40000000,0x0,0x80000,0x0,0x0,0x0,0x80000,0x800000,0x80000,0x800000,0x80000,0x3f740000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3,0x0,0x3,0x0,0x30,0x4,0x30,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
  ...
  protected InvenioQueryParser(CharStream stream) {
    token_source = new InvenioQueryParserTokenManager(stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  protected InvenioQueryParser(InvenioQueryParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(InvenioQueryParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
