...
public class TestInvenioQueryParser extends AbstractSolrTestCase {
  ...
  public void testQueryTypes() {
    ...
    QParserPlugin parserPlugin = core.getQueryPlugin(InvenioQParserPlugin.NAME);
    ...
    String[] queries = {
    		...
    		//find a m albrow and j phys.rev.lett. and t quark* cited:200->99999
    		...
    		"title:/dense ([^ l]* )?matter/",
    			"<title|\"/dense ([^ l]* )?matter/\">",   //TODO: remove the quotation marks
    ...
    for (int i=0; i<queries.length;i+=2) {
    	...
    	try {
    		...
    		qp2 = parserPlugin.createParser(inv_q, localParams_2, params, req);
    		...
    		System.out.println(localParams.get("iq.syntax") + "=" + (q!=null ? q.toString() : ""));
    		System.out.println(localParams_2.get("iq.syntax") + "=" + q2.toString());
    ...
    System.out.println("Total=" + queries.length/2 + " success=" + success);
