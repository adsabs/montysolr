...
-Dmontysolr.stagger.maxDelay=${MONTYSOLR_COORDINATE_MAX_DELAY:-2700} \
-Dmontysolr.stagger.numInstances=${MONTYSOLR_COORDINATE_NUM_INSTANCES:-3} \
-Dmontysolr.stagger.numTop=${MONTYSOLR_COORDINATE_NUM_TOP:-1} \
-Dmontysolr.stagger.numBottom=${MONTYSOLR_COORDINATE_NUM_BOTTOM:-1} \
...
-Dsolr.queryResultCache.size=${SOLR_QUERY_RESULT_MAX_DOCS_CACHED:-200} \
