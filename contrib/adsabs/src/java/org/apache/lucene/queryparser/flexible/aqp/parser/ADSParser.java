// $ANTLR 3.4 /dvt/workspace/montysolr/contrib/adsabs/grammars/ADS.g 2012-07-19 19:58:59
        ...
        try {
            ...
            switch (alt18) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: func_name, clauseOr, rmodifier, lmodifier
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt24) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: field, lmodifier, multi_value, rmodifier
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: lmodifier, value, rmodifier, field
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
