// $ANTLR 3.4 /dvt/workspace/montysolr/contrib/adsabs/grammars/ADS.g 2012-07-27 02:00:10
        ...
        try {
            ...
            switch (alt18) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: func_name, clauseOr, lmodifier, rmodifier
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt24) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: field, lmodifier, rmodifier, multi_value
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: field, rmodifier, value, lmodifier
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
