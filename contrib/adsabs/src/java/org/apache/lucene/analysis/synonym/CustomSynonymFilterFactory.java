 ...
 * &lt;/fieldType&gt;</pre>
 */
public class CustomSynonymFilterFactory extends TokenFilterFactory implements ResourceLoaderAware {
  ...
  private SynonymMap loadSolrSynonyms(ResourceLoader loader, boolean dedup, Analyzer analyzer) throws IOException, ParseException {
    ...
    final boolean inclOrig = getBoolean("inclOrig", false);
    final boolean sanitizeOutput = getBoolean("sanitizeOutput", false);
    ...
    CustomSolrSynonymParser parser = new CustomSolrSynonymParser(dedup, expand, analyzer);
    parser.setInclOrig(inclOrig);
    parser.setSanitizeOutput(sanitizeOutput);
