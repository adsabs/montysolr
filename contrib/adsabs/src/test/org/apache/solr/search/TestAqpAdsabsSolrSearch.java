...
public class TestAqpAdsabsSolrSearch extends MontySolrQueryTestCase {
	...
	public static String getSchemaFile() {
		...
		try {
			...
			File multiSynonymsFile = createTempFile(new String[] { "hubble\0space\0telescope, HST", "r\0s\0t, RST",
			...
			File synonymsFile = createTempFile(new String[] { "weak => lightweak", "lensing => mikrolinseneffekt",
			...
			File curatedSynonyms = createTempFile(new String[] { "JONES, CHRISTINE;FORMAN, CHRISTINE" // the famous
																										// post-synonym
																										// expansion
			});
	...
	public void testSpecialCases() throws Exception {
		...
		assertQueryEquals(req("defType", "aqp", "q", "similar(topn(200, abstract:foo), title abstract)"),
				"+like:foo bar baz title bitle  -BitSetQuery(" + Integer.toString(md - 1) + ")", BooleanQuery.class);
