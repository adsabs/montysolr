...
public class TestAdsabsTypeFulltextParsing extends MontySolrQueryTestCase {
  ...
  public void testMultiTokens() throws Exception {
    ...
    assertQueryEquals(req("q", "title:\"observations black hole\"",
        "aqp.multiphrase.keep_one", "SYNONYM"),
        "(title:\"observations black hole\" | title:\"observations syn::black hole\")",
        DisjunctionMaxQuery.class);
    ...
    assertQueryEquals(req("q", "title:\"observations black hole\""),
        "(title:\"observations black hole\" | title:\"observations (syn::black hole acr::bh)\")",
        DisjunctionMaxQuery.class);
    ...
    assertQueryEquals(req("q", "title:\"black hole event\"",
        "aqp.multiphrase.keep_one", "SYNONYM"),
        "(title:\"black hole event\" | title:\"syn::black hole ? event\"~1)",
        DisjunctionMaxQuery.class);
    ...
    assertQueryEquals(req("q", "title:\"observations black hole event\"",
        "aqp.multiphrase.keep_one", "SYNONYM"),
        "(title:\"observations black hole event\" | title:\"observations syn::black hole ? event\"~1)",
        DisjunctionMaxQuery.class);
    assertQ(req("q", "title:\"black hole event\"", "aqp.multiphrase.keep_one", "SYNONYM"), 
        "//*[@numFound='2']",
        "//doc/str[@name='id'][.='500']",
    ...
    assertQueryEquals(req("q", "title:\"observations BH\"",
        "aqp.multiphrase.keep_one", "SYNONYM"),
        "title:\"observations syn::black hole\"",
    ...
    assertQueryEquals(req("q", "title:\"BH event\""),
        "title:\"(acr::bh syn::black hole) event\"",
        MultiPhraseQuery.class);
    assertQ(req("q", "title:\"BH event\""), 
        "//*[@numFound='2']",
        "//doc/str[@name='id'][.='500']",
        "//doc/str[@name='id'][.='501']"
        );
    ...
    // no double-counting
    assertQueryEquals(req("q", "title:\"bubble pace telescope multi-pace foobar\"", 
        "defType", "aqp",
        "aqp.multiphrase.keep_one", "SYNONYM"), 
        "(title:\"bubble syn::lunar telescope multi syn::lunar foobar\" "
        + "| title:\"bubble syn::lunar telescope ? multipace foobar\" "
        + "| title:\"syn::bubble pace telescope ? ? multi syn::lunar foobar\"~2 "
        + "| title:\"syn::bubble pace telescope ? ? ? multipace foobar\"~3)",
        DisjunctionMaxQuery.class);
