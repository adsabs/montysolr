...
public class TestSecondOrderQueryTypesAds extends MontySolrAbstractTestCase {
    ...
    public void testADSOperators() throws Exception {
        ...
        assertEquals(1.0f, boostConstant.getFloat(0), 0.0);
        assertEquals(0.1f, boostOne.getFloat(0), 0.0);
        assertEquals(0.5f, boostTwo.getFloat(0), 0.0);
        ...
        boostTwo = LuceneCacheWrapper.getFloatCache(
                "boost_2", UninvertingReader.Type.FLOAT_POINT, tempReq.getSearcher().getSlowAtomicReader());
        testQ2(new SecondOrderQuery(new MatchAllDocsQuery(),
