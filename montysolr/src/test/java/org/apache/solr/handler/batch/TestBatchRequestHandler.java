...
public class TestBatchRequestHandler extends MontySolrQueryTestCase {
    ...
    public void test() throws Exception {
	    ...
	    */
        ...
        assert !thisQueue.isJobidFailed(jobid);
        assert thisQueue.isJobidFinished(jobid);
        assert thisQueue.isJobidRegistered(jobid);
        assert !thisQueue.isJobidRunning(jobid);
    ...
    private static final List<BatchHandlerRequestQueue> queue = new ArrayList<BatchHandlerRequestQueue>();
    private static final List<SolrParams> params = new ArrayList<SolrParams>();
