...
public class TestWriteableSynonymMap extends LuceneTestCase {
    ...
    public void testExplicitMap() throws IOException, InterruptedException {
        ...
        assertFalse(synMap.containsKey("Foo, Bar"));
        assertFalse(synMap.containsKey("Foo, Baer"));
        ...
        assertFalse(synMap.containsKey("Boo, Bar"));
        assertFalse(synMap.containsKey("Boo, Baer"));
        ...
        // add some synonyms
        synMap.add("Foo, Bär", new LinkedHashSet<String>() {{
            add("Fuu, Bar");
            add("Foo, Baer");
        }});
        synMap.add("Fuu, Bar", new LinkedHashSet<String>() {{
            add("Fuj, Taj");
        }});

        assertTrue(synMap.containsKey("Fuu, Bar"));
        assertTrue(synMap.get("Fuu, Bar").contains("Fuj, Taj"));
        assertFalse(synMap.get("Foo, Bär").contains("Fuj, Taj"));
    ...
    public void testEquivalentMap() throws IOException, InterruptedException {
        ...
        // add some synonyms
        synMap.add("Foo, Bär", new HashSet<String>() {{
            add("Fuu, Bar");
            add("Foo, Baer");
        }});
    ...
    private String readFile(File tmpFile) throws IOException {
        ...
        BufferedReader fi = new BufferedReader(new InputStreamReader(new DataInputStream(in), StandardCharsets.UTF_8));
