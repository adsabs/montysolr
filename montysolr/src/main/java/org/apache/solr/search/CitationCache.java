...
public interface CitationCache<K, V> extends SolrCache<K, V> {
     ...
     */
    void initializeCitationCache(int maxDocs);
     ...
     * @param targetDocId
     */
    void insertCitation(int sourceDocId, int targetDocId);
     ...
     * @param targetDocId
     */
    void insertReference(int sourceDocId, int targetDocId);
     ...
     */
    Iterator<Entry<K, V>> getDictionary();
