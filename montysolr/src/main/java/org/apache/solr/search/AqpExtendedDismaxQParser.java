...
public class AqpExtendedDismaxQParser extends QParser {
    ...
    private final ExtendedDismaxConfiguration config;
    ...
    static class UserFields {
        private final Map<String, Float> userFieldsMap;
        private final DynamicField[] dynamicUserFields;
        private final DynamicField[] negativeDynamicUserFields;
        ...
        private boolean isDynField(String field, boolean neg) {
            return getDynFieldForName(field, neg) != null;
        }
    ...
    static class DynamicField implements Comparable<DynamicField> {
        ...
        public boolean matches(String name) {
            ...
            else return type == ENDS_WITH && name.endsWith(str);
        }
