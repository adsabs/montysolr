...
public interface SecondOrderCollector {
     ...
     * @param firstOrderWeight weight built from the seed query
     */
    boolean searcherInitialization(IndexSearcher searcher, Weight firstOrderWeight) throws IOException;
