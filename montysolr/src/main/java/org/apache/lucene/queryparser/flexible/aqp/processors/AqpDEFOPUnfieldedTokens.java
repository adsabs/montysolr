...
public class AqpDEFOPUnfieldedTokens extends AqpQProcessor {
     ...
     */
    private final List<String> ignoreModifiers;

    /*
     * Dtto as above
     */
    private final List<String> ignoreTModifiers;
    private final List<String> ignoreFields;
    private final List<String> catchQTypes;
    private String operationMode;
    private final List<String> wildcardQTypes;
        ...
        if (node.getTokenLabel().equals("DEFOP")) {
            if (node.getParent() != null && node.getParent().getParent() != null) {
                ...
                if (immediateP.getTokenName().equals("TMODIFIER")
                    ...
                    return modifier.getTokenName() == null || ignoreModifiers.contains(modifier.getTokenName());
                }
            }
            return true;
        }
    ...
    private Set<String> getIgnoredFields() {
        ...
        if (obj != null) {
            ...
            Collections.addAll(aqpIgnorableFields, vals);
        }
