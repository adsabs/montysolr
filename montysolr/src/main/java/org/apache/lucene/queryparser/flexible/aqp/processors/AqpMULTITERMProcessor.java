...
public class AqpMULTITERMProcessor extends QueryNodeProcessorImpl implements
    ...
    protected QueryNode preProcessNode(QueryNode node) throws QueryNodeException {
        if (node instanceof AqpANTLRNode
            ...
            AqpANTLRNode modifierNode = mNode.getChild("MODIFIER");
            AqpANTLRNode fieldNode = mNode.getChild("FIELD");
            AqpANTLRNode multiNode = mNode.getChild("MULTIATOM");
            AqpANTLRNode tModifierNode = mNode.getChild("TMODIFIER");
