...
public class AqpANTLRNode extends QueryNodeImpl {
    ...
    private final AqpCommonTree tree;
    ...
    public void setTokenStart(int start) {
        ...
        tree.getToken().setCharPositionInLine(start);
    }
    ...
    public int getInputTokenStart() {
        return tree.getToken().getCharPositionInLine();// getStartIndex();
    }
