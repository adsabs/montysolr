...
// inspired by: http://code.google.com/a/apache-extras.org/p/luceneutil/source/browse/perf/CreateQueries.java
...
public class CreateQueries {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final BufferedWriter queriesOut = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(queriesFileOut), StandardCharsets.UTF_8));
