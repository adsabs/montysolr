...
# this is the only modification to the parser; we need to avoid
# loading logging because that loads weakref and that causes
# some lingering weakrefs to be not collected
if False:
    import logging
