// $ANTLR 3.4 Invenio.g 2011-09-29 03:14:27
...
public TreeAdaptor getTreeAdaptor() {
    ...
    // $ANTLR start "mainQ"
    // Invenio.g:34:1: mainQ : ( clauseDefault )+ -> ^( OPERATOR[\"AND\"] ( clauseDefault )+ ) ;
    public final InvenioParser.mainQ_return mainQ() throws RecognitionException {
        ...
        InvenioParser.clauseDefault_return clauseDefault1 =null;


        RewriteRuleSubtreeStream stream_clauseDefault=new RewriteRuleSubtreeStream(adaptor,"rule clauseDefault");
        try {
            // Invenio.g:34:7: ( ( clauseDefault )+ -> ^( OPERATOR[\"AND\"] ( clauseDefault )+ ) )
            // Invenio.g:35:2: ( clauseDefault )+
            {
            // Invenio.g:35:2: ( clauseDefault )+
            int cnt1=0;
            loop1:
            do {
                ...
                if ( ((LA1_0 >= LBRACK && LA1_0 <= LPAREN)||LA1_0==NUMBER||(LA1_0 >= PHRASE && LA1_0 <= PHRASE_ANYTHING)||(LA1_0 >= TERM_NORMAL && LA1_0 <= TERM_TRUNCATED)||LA1_0==51) ) {
                    alt1=1;
                }
            ...
            {
                // Invenio.g:35:20: ^( OPERATOR[\"AND\"] ( clauseDefault )+ )
                {
    ...
    // Invenio.g:39:1: clauseDefault : (first= clauseStrongest -> $first) ( NOT others= clauseStrongest -> ^( OPERATOR[\"NOT\"] ( clauseStrongest )+ ) )* ;
    public final InvenioParser.clauseDefault_return clauseDefault() throws RecognitionException {
        InvenioParser.clauseDefault_return retval = new InvenioParser.clauseDefault_return();
        retval.start = input.LT(1);
        ...
        Token NOT2=null;
        InvenioParser.clauseStrongest_return first =null;

        InvenioParser.clauseStrongest_return others =null;
        ...
        try {
            // Invenio.g:40:3: ( (first= clauseStrongest -> $first) ( NOT others= clauseStrongest -> ^( OPERATOR[\"NOT\"] ( clauseStrongest )+ ) )* )
            // Invenio.g:40:5: (first= clauseStrongest -> $first) ( NOT others= clauseStrongest -> ^( OPERATOR[\"NOT\"] ( clauseStrongest )+ ) )*
            {
            // Invenio.g:40:5: (first= clauseStrongest -> $first)
            // Invenio.g:40:6: first= clauseStrongest
            {
            ...
            // Invenio.g:40:39: ( NOT others= clauseStrongest -> ^( OPERATOR[\"NOT\"] ( clauseStrongest )+ ) )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // Invenio.g:40:40: NOT others= clauseStrongest
            	    {
            	    ...
            	    {
            	        // Invenio.g:40:70: ^( OPERATOR[\"NOT\"] ( clauseStrongest )+ )
            	        {
            	        Object root_1 = (Object)adaptor.nil();
            	        root_1 = (Object)adaptor.becomeRoot(
    ...
    // Invenio.g:43:1: clauseStrongest : (first= clauseStrong -> $first) ( AND others= clauseStrong -> ^( OPERATOR[\"AND\"] ( clauseStrong )+ ) )* ;
    public final InvenioParser.clauseStrongest_return clauseStrongest() throws RecognitionException {
        InvenioParser.clauseStrongest_return retval = new InvenioParser.clauseStrongest_return();
        retval.start = input.LT(1);
        ...
        Token AND3=null;
        InvenioParser.clauseStrong_return first =null;

        InvenioParser.clauseStrong_return others =null;
        ...
        try {
            // Invenio.g:44:3: ( (first= clauseStrong -> $first) ( AND others= clauseStrong -> ^( OPERATOR[\"AND\"] ( clauseStrong )+ ) )* )
            // Invenio.g:44:5: (first= clauseStrong -> $first) ( AND others= clauseStrong -> ^( OPERATOR[\"AND\"] ( clauseStrong )+ ) )*
            {
            // Invenio.g:44:5: (first= clauseStrong -> $first)
            // Invenio.g:44:6: first= clauseStrong
            {
            ...
            // Invenio.g:44:37: ( AND others= clauseStrong -> ^( OPERATOR[\"AND\"] ( clauseStrong )+ ) )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // Invenio.g:44:38: AND others= clauseStrong
            	    {
            	    ...
            	    {
            	        // Invenio.g:44:65: ^( OPERATOR[\"AND\"] ( clauseStrong )+ )
            	        {
            	        Object root_1 = (Object)adaptor.nil();
            	        root_1 = (Object)adaptor.becomeRoot(
            	        (Object)adaptor.create(OPERATOR, "AND")
    ...
    // Invenio.g:47:1: clauseStrong : (first= clauseWeak -> $first) ( OR others= clauseWeak -> ^( OPERATOR[\"OR\"] ( clauseWeak )+ ) )* ;
    public final InvenioParser.clauseStrong_return clauseStrong() throws RecognitionException {
        InvenioParser.clauseStrong_return retval = new InvenioParser.clauseStrong_return();
        retval.start = input.LT(1);
        ...
        Token OR4=null;
        InvenioParser.clauseWeak_return first =null;

        InvenioParser.clauseWeak_return others =null;
        ...
        try {
            // Invenio.g:48:3: ( (first= clauseWeak -> $first) ( OR others= clauseWeak -> ^( OPERATOR[\"OR\"] ( clauseWeak )+ ) )* )
            // Invenio.g:48:5: (first= clauseWeak -> $first) ( OR others= clauseWeak -> ^( OPERATOR[\"OR\"] ( clauseWeak )+ ) )*
            {
            // Invenio.g:48:5: (first= clauseWeak -> $first)
            // Invenio.g:48:6: first= clauseWeak
            {
            ...
            // Invenio.g:48:34: ( OR others= clauseWeak -> ^( OPERATOR[\"OR\"] ( clauseWeak )+ ) )*
            loop4:
            do {
                int alt4=2;
                ...
                switch (alt4) {
            	case 1 :
            	    // Invenio.g:48:35: OR others= clauseWeak
            	    {
            	    ...
            	    {
            	        // Invenio.g:48:59: ^( OPERATOR[\"OR\"] ( clauseWeak )+ )
            	        {
            	        Object root_1 = (Object)adaptor.nil();
            	        root_1 = (Object)adaptor.becomeRoot(
    ...
    // Invenio.g:51:1: clauseWeak : (first= primaryClause -> $first) ( near others= primaryClause -> ^( near ( primaryClause )+ ) )* ;
    public final InvenioParser.clauseWeak_return clauseWeak() throws RecognitionException {
        InvenioParser.clauseWeak_return retval = new InvenioParser.clauseWeak_return();
        retval.start = input.LT(1);


        Object root_0 = null;

        InvenioParser.primaryClause_return first =null;

        InvenioParser.primaryClause_return others =null;

        InvenioParser.near_return near5 =null;
        ...
        try {
            // Invenio.g:52:3: ( (first= primaryClause -> $first) ( near others= primaryClause -> ^( near ( primaryClause )+ ) )* )
            // Invenio.g:52:5: (first= primaryClause -> $first) ( near others= primaryClause -> ^( near ( primaryClause )+ ) )*
            {
            // Invenio.g:52:5: (first= primaryClause -> $first)
            // Invenio.g:52:6: first= primaryClause
            {
            ...
            // Invenio.g:52:37: ( near others= primaryClause -> ^( near ( primaryClause )+ ) )*
            loop5:
            do {
                int alt5=2;
                ...
                switch (alt5) {
            	case 1 :
            	    // Invenio.g:52:38: near others= primaryClause
            	    {
            	    ...
            	    {
            	        // Invenio.g:52:67: ^( near ( primaryClause )+ )
            	        {
            	        Object root_1 = (Object)adaptor.nil();
    ...
    // Invenio.g:55:1: primaryClause : ( ( modifier LPAREN ( clauseDefault )+ RPAREN )=> ( modifier )? LPAREN ( clauseDefault )+ RPAREN ( CARAT NUMBER )? -> ^( CLAUSE ^( MODIFIER ( modifier )? ) ^( BOOST ( NUMBER )? ) ^( OPERATOR[\"AND\"] ( clauseDefault )+ ) ) | ( LPAREN ( clauseDefault )+ RPAREN CARAT NUMBER )=> ( modifier )? LPAREN ( clauseDefault )+ RPAREN ( CARAT NUMBER )? -> ^( CLAUSE ^( MODIFIER ( modifier )? ) ^( BOOST ( NUMBER )? ) ^( OPERATOR[\"AND\"] ( clauseDefault )+ ) ) | ( LPAREN )=> LPAREN ( clauseDefault )+ RPAREN -> ( clauseDefault )+ | atom );
    public final InvenioParser.primaryClause_return primaryClause() throws RecognitionException {
        InvenioParser.primaryClause_return retval = new InvenioParser.primaryClause_return();
        retval.start = input.LT(1);
        ...
        Token LPAREN18=null;
        Token RPAREN20=null;
        InvenioParser.modifier_return modifier6 =null;

        InvenioParser.clauseDefault_return clauseDefault8 =null;

        InvenioParser.modifier_return modifier12 =null;

        InvenioParser.clauseDefault_return clauseDefault14 =null;

        InvenioParser.clauseDefault_return clauseDefault19 =null;

        InvenioParser.atom_return atom21 =null;
        ...
        RewriteRuleSubtreeStream stream_clauseDefault=new RewriteRuleSubtreeStream(adaptor,"rule clauseDefault");
        try {
            // Invenio.g:56:2: ( ( modifier LPAREN ( clauseDefault )+ RPAREN )=> ( modifier )? LPAREN ( clauseDefault )+ RPAREN ( CARAT NUMBER )? -> ^( CLAUSE ^( MODIFIER ( modifier )? ) ^( BOOST ( NUMBER )? ) ^( OPERATOR[\"AND\"] ( clauseDefault )+ ) ) | ( LPAREN ( clauseDefault )+ RPAREN CARAT NUMBER )=> ( modifier )? LPAREN ( clauseDefault )+ RPAREN ( CARAT NUMBER )? -> ^( CLAUSE ^( MODIFIER ( modifier )? ) ^( BOOST ( NUMBER )? ) ^( OPERATOR[\"AND\"] ( clauseDefault )+ ) ) | ( LPAREN )=> LPAREN ( clauseDefault )+ RPAREN -> ( clauseDefault )+ | atom )
            int alt13=4;
            switch ( input.LA(1) ) {
            case 51:
                {
            ...
            switch (alt13) {
                case 1 :
                    // Invenio.g:58:2: ( modifier LPAREN ( clauseDefault )+ RPAREN )=> ( modifier )? LPAREN ( clauseDefault )+ RPAREN ( CARAT NUMBER )?
                    {
                    // Invenio.g:58:45: ( modifier )?
                    int alt6=2;
                    ...
                    do {
                        ...
                        if ( ((LA7_0 >= LBRACK && LA7_0 <= LPAREN)||LA7_0==NUMBER||(LA7_0 >= PHRASE && LA7_0 <= PHRASE_ANYTHING)||(LA7_0 >= TERM_NORMAL && LA7_0 <= TERM_TRUNCATED)||LA7_0==51) ) {
                            alt7=1;
                        }
                    ...
                    {
                        // Invenio.g:58:103: ^( CLAUSE ^( MODIFIER ( modifier )? ) ^( BOOST ( NUMBER )? ) ^( OPERATOR[\"AND\"] ( clauseDefault )+ ) )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        ...
                        // Invenio.g:58:112: ^( MODIFIER ( modifier )? )
                        {
                        ...
                        // Invenio.g:58:151: ^( OPERATOR[\"AND\"] ( clauseDefault )+ )
                        {
                        Object root_2 = (Object)adaptor.nil();
                        root_2 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(OPERATOR, "AND")
                    ...
                    break;
                case 2 :
                    // Invenio.g:59:4: ( LPAREN ( clauseDefault )+ RPAREN CARAT NUMBER )=> ( modifier )? LPAREN ( clauseDefault )+ RPAREN ( CARAT NUMBER )?
                    {
                    // Invenio.g:59:50: ( modifier )?
                    int alt9=2;
                    ...
                    do {
                        ...
                        if ( ((LA10_0 >= LBRACK && LA10_0 <= LPAREN)||LA10_0==NUMBER||(LA10_0 >= PHRASE && LA10_0 <= PHRASE_ANYTHING)||(LA10_0 >= TERM_NORMAL && LA10_0 <= TERM_TRUNCATED)||LA10_0==51) ) {
                            alt10=1;
                        }
                    ...
                    {
                        // Invenio.g:59:108: ^( CLAUSE ^( MODIFIER ( modifier )? ) ^( BOOST ( NUMBER )? ) ^( OPERATOR[\"AND\"] ( clauseDefault )+ ) )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(CLAUSE, "CLAUSE")
                        ...
                        // Invenio.g:59:117: ^( MODIFIER ( modifier )? )
                        {
                        Object root_2 = (Object)adaptor.nil();
                        root_2 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(MODIFIER, "MODIFIER")
                        ...
                        // Invenio.g:59:156: ^( OPERATOR[\"AND\"] ( clauseDefault )+ )
                        {
                        Object root_2 = (Object)adaptor.nil();
                        root_2 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(OPERATOR, "AND")
                    ...
                    break;
                case 3 :
                    // Invenio.g:60:4: ( LPAREN )=> LPAREN ( clauseDefault )+ RPAREN
                    {
                    ...
                    do {
                        ...
                        if ( ((LA12_0 >= LBRACK && LA12_0 <= LPAREN)||LA12_0==NUMBER||(LA12_0 >= PHRASE && LA12_0 <= PHRASE_ANYTHING)||(LA12_0 >= TERM_NORMAL && LA12_0 <= TERM_TRUNCATED)||LA12_0==51) ) {
                            alt12=1;
                        }
    ...
    // $ANTLR start "atom"
    // Invenio.g:65:1: atom : ( ( modifier )? field multi_value -> ^( ATOM ^( MODIFIER ( modifier )? ) ^( FIELD field ) ^( VALUE multi_value ) ) | ( modifier )? ( field )? value -> ^( ATOM ^( MODIFIER ( modifier )? ) ^( FIELD ( field )? ) ^( VALUE value ) ) );
    public final InvenioParser.atom_return atom() throws RecognitionException {
        ...
        InvenioParser.modifier_return modifier22 =null;

        InvenioParser.field_return field23 =null;

        InvenioParser.multi_value_return multi_value24 =null;

        InvenioParser.modifier_return modifier25 =null;

        InvenioParser.field_return field26 =null;

        InvenioParser.value_return value27 =null;
        ...
        try {
            // Invenio.g:66:2: ( ( modifier )? field multi_value -> ^( ATOM ^( MODIFIER ( modifier )? ) ^( FIELD field ) ^( VALUE multi_value ) ) | ( modifier )? ( field )? value -> ^( ATOM ^( MODIFIER ( modifier )? ) ^( FIELD ( field )? ) ^( VALUE value ) ) )
            int alt17=2;
            switch ( input.LA(1) ) {
            case 51:
                {
                ...
                if ( (LA17_1==TERM_NORMAL) ) {
                    ...
                    else if ( (LA17_2==EOF||LA17_2==AND||LA17_2==CARAT||(LA17_2 >= LBRACK && LA17_2 <= LPAREN)||LA17_2==NEAR||(LA17_2 >= NOT && LA17_2 <= NUMBER)||(LA17_2 >= OR && LA17_2 <= PHRASE_ANYTHING)||LA17_2==RPAREN||(LA17_2 >= TERM_NORMAL && LA17_2 <= TILDE)||LA17_2==51) ) {
                        alt17=2;
                    }
                    else {
                        if (state.backtracking>0) {state.failed=true; return retval;}
            ...
            switch (alt17) {
                case 1 :
                    // Invenio.g:67:2: ( modifier )? field multi_value
                    {
                    // Invenio.g:67:2: ( modifier )?
                    int alt14=2;
                    ...
                    {
                        // Invenio.g:67:33: ^( ATOM ^( MODIFIER ( modifier )? ) ^( FIELD field ) ^( VALUE multi_value ) )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        ...
                        // Invenio.g:67:40: ^( MODIFIER ( modifier )? )
                        {
                        Object root_2 = (Object)adaptor.nil();
                        root_2 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(MODIFIER, "MODIFIER")
                        ...
                        // Invenio.g:67:77: ^( VALUE multi_value )
                        {
                        Object root_2 = (Object)adaptor.nil();
                        root_2 = (Object)adaptor.becomeRoot(
                    ...
                    break;
                case 2 :
                    // Invenio.g:68:4: ( modifier )? ( field )? value
                    {
                    // Invenio.g:68:4: ( modifier )?
                    int alt15=2;
                    ...
                    {
                        // Invenio.g:68:30: ^( ATOM ^( MODIFIER ( modifier )? ) ^( FIELD ( field )? ) ^( VALUE value ) )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(ATOM, "ATOM")
                        ...
                        // Invenio.g:68:37: ^( MODIFIER ( modifier )? )
                        {
                        Object root_2 = (Object)adaptor.nil();
                        root_2 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(MODIFIER, "MODIFIER")
    ...
    // $ANTLR start "field"
    // Invenio.g:72:1: field : TERM_NORMAL COLON -> TERM_NORMAL ;
    public final InvenioParser.field_return field() throws RecognitionException {
        ...
        try {
            // Invenio.g:73:2: ( TERM_NORMAL COLON -> TERM_NORMAL )
            // Invenio.g:74:2: TERM_NORMAL COLON
            {
    ...
    // $ANTLR start "value"
    // Invenio.g:77:1: value : ( range_term_in -> ^( QRANGEIN range_term_in ) | range_term_ex -> ^( QRANGEEX range_term_ex ) | normal -> ^( QNORMAL normal ) | truncated -> ^( QTRUNCATED truncated ) | quoted -> ^( QPHRASE quoted ) | quoted_truncated -> ^( QPHRASETRUNC quoted_truncated ) ) ( term_modifier )? -> ( term_modifier )? $value;
    public final InvenioParser.value_return value() throws RecognitionException {
        ...
        InvenioParser.range_term_in_return range_term_in30 =null;

        InvenioParser.range_term_ex_return range_term_ex31 =null;

        InvenioParser.normal_return normal32 =null;

        InvenioParser.truncated_return truncated33 =null;

        InvenioParser.quoted_return quoted34 =null;

        InvenioParser.quoted_truncated_return quoted_truncated35 =null;

        InvenioParser.term_modifier_return term_modifier36 =null;
        ...
        try {
            // Invenio.g:78:2: ( ( range_term_in -> ^( QRANGEIN range_term_in ) | range_term_ex -> ^( QRANGEEX range_term_ex ) | normal -> ^( QNORMAL normal ) | truncated -> ^( QTRUNCATED truncated ) | quoted -> ^( QPHRASE quoted ) | quoted_truncated -> ^( QPHRASETRUNC quoted_truncated ) ) ( term_modifier )? -> ( term_modifier )? $value)
            // Invenio.g:79:2: ( range_term_in -> ^( QRANGEIN range_term_in ) | range_term_ex -> ^( QRANGEEX range_term_ex ) | normal -> ^( QNORMAL normal ) | truncated -> ^( QTRUNCATED truncated ) | quoted -> ^( QPHRASE quoted ) | quoted_truncated -> ^( QPHRASETRUNC quoted_truncated ) ) ( term_modifier )?
            {
            // Invenio.g:79:2: ( range_term_in -> ^( QRANGEIN range_term_in ) | range_term_ex -> ^( QRANGEEX range_term_ex ) | normal -> ^( QNORMAL normal ) | truncated -> ^( QTRUNCATED truncated ) | quoted -> ^( QPHRASE quoted ) | quoted_truncated -> ^( QPHRASETRUNC quoted_truncated ) )
            int alt18=6;
            switch ( input.LA(1) ) {
            case LBRACK:
                {
            ...
            switch (alt18) {
                case 1 :
                    ...
                    {
                        // Invenio.g:80:19: ^( QRANGEIN range_term_in )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                ...
                case 2 :
                    ...
                    {
                        // Invenio.g:81:21: ^( QRANGEEX range_term_ex )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                ...
                case 3 :
                    ...
                    {
                        // Invenio.g:82:14: ^( QNORMAL normal )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                ...
                case 4 :
                    ...
                    {
                        // Invenio.g:83:17: ^( QTRUNCATED truncated )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                ...
                case 5 :
                    ...
                    {
                        // Invenio.g:84:14: ^( QPHRASE quoted )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                    ...
                    break;
                case 6 :
                    // Invenio.g:85:4: quoted_truncated
                    {
                    ...
                    {
                        // Invenio.g:85:24: ^( QPHRASETRUNC quoted_truncated )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
    ...
    // Invenio.g:92:1: range_term_in : LBRACK (a= range_value -> range_value ^( QANYTHING ) ) ( ( TO )? b= range_value -> $a ( $b)? )? RBRACK ;
    public final InvenioParser.range_term_in_return range_term_in() throws RecognitionException {
        ...
        try {
            // Invenio.g:93:2: ( LBRACK (a= range_value -> range_value ^( QANYTHING ) ) ( ( TO )? b= range_value -> $a ( $b)? )? RBRACK )
            // Invenio.g:94:8: LBRACK (a= range_value -> range_value ^( QANYTHING ) ) ( ( TO )? b= range_value -> $a ( $b)? )? RBRACK
            {
            ...
            // Invenio.g:95:8: (a= range_value -> range_value ^( QANYTHING ) )
            // Invenio.g:95:9: a= range_value
            {
            ...
            // Invenio.g:96:8: ( ( TO )? b= range_value -> $a ( $b)? )?
            int alt21=2;
            ...
            switch (alt21) {
                case 1 :
                    // Invenio.g:96:10: ( TO )? b= range_value
                    {
                    // Invenio.g:96:10: ( TO )?
                    int alt20=2;
    ...
    // Invenio.g:101:1: range_term_ex : LCURLY (a= range_value -> range_value ^( QANYTHING ) ) ( ( TO )? b= range_value -> $a ( $b)? )? RCURLY ;
    public final InvenioParser.range_term_ex_return range_term_ex() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_range_value=new RewriteRuleSubtreeStream(adaptor,"rule range_value");
        try {
            // Invenio.g:102:2: ( LCURLY (a= range_value -> range_value ^( QANYTHING ) ) ( ( TO )? b= range_value -> $a ( $b)? )? RCURLY )
            // Invenio.g:103:8: LCURLY (a= range_value -> range_value ^( QANYTHING ) ) ( ( TO )? b= range_value -> $a ( $b)? )? RCURLY
            {
            ...
            // Invenio.g:104:8: (a= range_value -> range_value ^( QANYTHING ) )
            // Invenio.g:104:10: a= range_value
            {
            ...
            // Invenio.g:105:8: ( ( TO )? b= range_value -> $a ( $b)? )?
            int alt23=2;
            ...
            switch (alt23) {
                case 1 :
                    // Invenio.g:105:10: ( TO )? b= range_value
                    {
                    // Invenio.g:105:10: ( TO )?
                    int alt22=2;
    ...
    // Invenio.g:109:1: range_value : ( normal -> ^( QNORMAL normal ) | truncated -> ^( QTRUNCATED truncated ) | quoted -> ^( QPHRASE quoted ) | quoted_truncated -> ^( QPHRASETRUNC quoted_truncated ) | STAR -> ^( QANYTHING ) );
    public final InvenioParser.range_value_return range_value() throws RecognitionException {
        ...
        Token STAR47=null;
        InvenioParser.normal_return normal43 =null;

        InvenioParser.truncated_return truncated44 =null;

        InvenioParser.quoted_return quoted45 =null;

        InvenioParser.quoted_truncated_return quoted_truncated46 =null;
        ...
        RewriteRuleSubtreeStream stream_truncated=new RewriteRuleSubtreeStream(adaptor,"rule truncated");
        try {
            // Invenio.g:110:2: ( normal -> ^( QNORMAL normal ) | truncated -> ^( QTRUNCATED truncated ) | quoted -> ^( QPHRASE quoted ) | quoted_truncated -> ^( QPHRASETRUNC quoted_truncated ) | STAR -> ^( QANYTHING ) )
            int alt24=5;
            switch ( input.LA(1) ) {
            case NUMBER:
            case TERM_NORMAL:
            ...
            switch (alt24) {
                case 1 :
                    ...
                    {
                        // Invenio.g:111:12: ^( QNORMAL normal )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(QNORMAL, "QNORMAL")
                ...
                case 2 :
                    ...
                    {
                        // Invenio.g:112:17: ^( QTRUNCATED truncated )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(QTRUNCATED, "QTRUNCATED")
                ...
                case 3 :
                    ...
                    {
                        // Invenio.g:113:14: ^( QPHRASE quoted )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(QPHRASE, "QPHRASE")
                    ...
                    break;
                case 4 :
                    // Invenio.g:114:4: quoted_truncated
                    {
                    ...
                    {
                        // Invenio.g:114:24: ^( QPHRASETRUNC quoted_truncated )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(QPHRASETRUNC, "QPHRASETRUNC")
    ...
    // Invenio.g:118:1: multi_value : LPAREN ( mterm )+ RPAREN -> ( mterm )+ ;
    public final InvenioParser.multi_value_return multi_value() throws RecognitionException {
        ...
        Token LPAREN48=null;
        Token RPAREN50=null;
        InvenioParser.mterm_return mterm49 =null;
        ...
        try {
            // Invenio.g:119:2: ( LPAREN ( mterm )+ RPAREN -> ( mterm )+ )
            // Invenio.g:120:2: LPAREN ( mterm )+ RPAREN
            {
            ...
            do {
                ...
                if ( ((LA25_0 >= LBRACK && LA25_0 <= LCURLY)||LA25_0==NUMBER||(LA25_0 >= PHRASE && LA25_0 <= PHRASE_ANYTHING)||(LA25_0 >= TERM_NORMAL && LA25_0 <= TERM_TRUNCATED)||LA25_0==51) ) {
                    alt25=1;
                }
    ...
    // $ANTLR start "mterm"
    // Invenio.g:124:1: mterm : ( ( modifier )? value -> ^( ATOM ^( MODIFIER ( modifier )? ) ^( VALUE value ) ) ) ;
    public final InvenioParser.mterm_return mterm() throws RecognitionException {
        ...
        InvenioParser.modifier_return modifier51 =null;

        InvenioParser.value_return value52 =null;


        RewriteRuleSubtreeStream stream_modifier=new RewriteRuleSubtreeStream(adaptor,"rule modifier");
        RewriteRuleSubtreeStream stream_value=new RewriteRuleSubtreeStream(adaptor,"rule value");
        try {
            // Invenio.g:125:2: ( ( ( modifier )? value -> ^( ATOM ^( MODIFIER ( modifier )? ) ^( VALUE value ) ) ) )
            // Invenio.g:126:2: ( ( modifier )? value -> ^( ATOM ^( MODIFIER ( modifier )? ) ^( VALUE value ) ) )
            {
            // Invenio.g:126:2: ( ( modifier )? value -> ^( ATOM ^( MODIFIER ( modifier )? ) ^( VALUE value ) ) )
            // Invenio.g:126:3: ( modifier )? value
            {
            // Invenio.g:126:3: ( modifier )?
            int alt26=2;
            ...
            {
                // Invenio.g:126:22: ^( ATOM ^( MODIFIER ( modifier )? ) ^( VALUE value ) )
                {
                Object root_1 = (Object)adaptor.nil();
                root_1 = (Object)adaptor.becomeRoot(
                (Object)adaptor.create(ATOM, "ATOM")
                ...
                // Invenio.g:126:29: ^( MODIFIER ( modifier )? )
                {
                Object root_2 = (Object)adaptor.nil();
                root_2 = (Object)adaptor.becomeRoot(
                (Object)adaptor.create(MODIFIER, "MODIFIER")
    ...
    // $ANTLR start "normal"
    // Invenio.g:130:1: normal : ( TERM_NORMAL | NUMBER );
    public final InvenioParser.normal_return normal() throws RecognitionException {
        ...
        try {
            // Invenio.g:131:2: ( TERM_NORMAL | NUMBER )
            // Invenio.g:
            {
            root_0 = (Object)adaptor.nil();
    ...
    // Invenio.g:139:1: truncated : TERM_TRUNCATED ;
    public final InvenioParser.truncated_return truncated() throws RecognitionException {
        ...
        try {
            // Invenio.g:140:2: ( TERM_TRUNCATED )
            // Invenio.g:141:2: TERM_TRUNCATED
            {
            root_0 = (Object)adaptor.nil();
    ...
    // Invenio.g:145:1: quoted_truncated : PHRASE_ANYTHING ;
    public final InvenioParser.quoted_truncated_return quoted_truncated() throws RecognitionException {
        ...
        try {
            // Invenio.g:146:2: ( PHRASE_ANYTHING )
            // Invenio.g:147:2: PHRASE_ANYTHING
            {
            root_0 = (Object)adaptor.nil();
    ...
    public final InvenioParser.quoted_return quoted() throws RecognitionException {
        ...
        try {
            // Invenio.g:150:8: ( PHRASE )
            // Invenio.g:151:2: PHRASE
            {
            root_0 = (Object)adaptor.nil();
    ...
    // Invenio.g:157:1: operator : ( AND | OR | NOT | NEAR ) ;
    public final InvenioParser.operator_return operator() throws RecognitionException {
        ...
        try {
            // Invenio.g:157:9: ( ( AND | OR | NOT | NEAR ) )
            // Invenio.g:
            {
            root_0 = (Object)adaptor.nil();
    ...
    public final InvenioParser.modifier_return modifier() throws RecognitionException {
        ...
        try {
            ...
            // Invenio.g:159:12: '#'
            {
            char_literal58=(Token)match(input,51,FOLLOW_51_in_modifier1117); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            char_literal58_tree = 
    ...
    // Invenio.g:171:1: term_modifier : ( ( ( CARAT b= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY ) ) ) ( ( TILDE NUMBER )=> TILDE f= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY $f) ) | TILDE -> ^( MODIFIER ^( BOOST $b) ^( FUZZY NUMBER[\"0.5\"] ) ) )* ) | ( TILDE -> ^( MODIFIER ^( BOOST ) ^( FUZZY NUMBER[\"0.5\"] ) ) ) ( (~ ( WS | TILDE | CARAT ) )=>f= NUMBER -> ^( MODIFIER ^( BOOST ) ^( FUZZY ( $f)? ) ) )* );
    public final InvenioParser.term_modifier_return term_modifier() throws RecognitionException {
        ...
        try {
            // Invenio.g:171:15: ( ( ( CARAT b= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY ) ) ) ( ( TILDE NUMBER )=> TILDE f= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY $f) ) | TILDE -> ^( MODIFIER ^( BOOST $b) ^( FUZZY NUMBER[\"0.5\"] ) ) )* ) | ( TILDE -> ^( MODIFIER ^( BOOST ) ^( FUZZY NUMBER[\"0.5\"] ) ) ) ( (~ ( WS | TILDE | CARAT ) )=>f= NUMBER -> ^( MODIFIER ^( BOOST ) ^( FUZZY ( $f)? ) ) )* )
            int alt29=2;
            ...
            switch (alt29) {
                case 1 :
                    // Invenio.g:173:2: ( ( CARAT b= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY ) ) ) ( ( TILDE NUMBER )=> TILDE f= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY $f) ) | TILDE -> ^( MODIFIER ^( BOOST $b) ^( FUZZY NUMBER[\"0.5\"] ) ) )* )
                    {
                    // Invenio.g:173:2: ( ( CARAT b= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY ) ) ) ( ( TILDE NUMBER )=> TILDE f= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY $f) ) | TILDE -> ^( MODIFIER ^( BOOST $b) ^( FUZZY NUMBER[\"0.5\"] ) ) )* )
                    // Invenio.g:174:4: ( CARAT b= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY ) ) ) ( ( TILDE NUMBER )=> TILDE f= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY $f) ) | TILDE -> ^( MODIFIER ^( BOOST $b) ^( FUZZY NUMBER[\"0.5\"] ) ) )*
                    {
                    // Invenio.g:174:4: ( CARAT b= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY ) ) )
                    // Invenio.g:174:5: CARAT b= NUMBER
                    {
                    CARAT59=(Token)match(input,CARAT,FOLLOW_CARAT_in_term_modifier1139); if (state.failed) return retval; 
                    if ( state.backtracking==0 ) stream_CARAT.add(CARAT59);


                    b=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_term_modifier1143); if (state.failed) return retval; 
                    ...
                    {
                        // Invenio.g:174:23: ^( MODIFIER ^( BOOST $b) ^( FUZZY ) )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(MODIFIER, "MODIFIER")
                    ...
                    // Invenio.g:176:2: ( ( TILDE NUMBER )=> TILDE f= NUMBER -> ^( MODIFIER ^( BOOST $b) ^( FUZZY $f) ) | TILDE -> ^( MODIFIER ^( BOOST $b) ^( FUZZY NUMBER[\"0.5\"] ) ) )*
                    loop27:
                    do {
                        int alt27=3;
                        ...
                        if ( (LA27_0==TILDE) ) {
                            ...
                            else if ( (LA27_2==EOF||LA27_2==AND||(LA27_2 >= LBRACK && LA27_2 <= LPAREN)||LA27_2==NEAR||LA27_2==NOT||(LA27_2 >= OR && LA27_2 <= PHRASE_ANYTHING)||LA27_2==RPAREN||(LA27_2 >= TERM_NORMAL && LA27_2 <= TILDE)||LA27_2==51) ) {
                                alt27=2;
                            }
                        ...
                        switch (alt27) {
                    	case 1 :
                    	    // Invenio.g:177:3: ( TILDE NUMBER )=> TILDE f= NUMBER
                    	    {
                    	    TILDE60=(Token)match(input,TILDE,FOLLOW_TILDE_in_term_modifier1181); if (state.failed) return retval; 
                    	    if ( state.backtracking==0 ) stream_TILDE.add(TILDE60);


                    	    f=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_term_modifier1185); if (state.failed) return retval; 
                    	    ...
                    	    {
                    	        // Invenio.g:177:38: ^( MODIFIER ^( BOOST $b) ^( FUZZY $f) )
                    	        {
                    	        Object root_1 = (Object)adaptor.nil();
                    	        root_1 = (Object)adaptor.becomeRoot(
                    	        (Object)adaptor.create(MODIFIER, "MODIFIER")
                    	    ...
                    	    break;
                    	case 2 :
                    	    // Invenio.g:178:5: TILDE
                    	    {
                    	    TILDE61=(Token)match(input,TILDE,FOLLOW_TILDE_in_term_modifier1212); if (state.failed) return retval; 
                    	    ...
                    	    {
                    	        // Invenio.g:178:14: ^( MODIFIER ^( BOOST $b) ^( FUZZY NUMBER[\"0.5\"] ) )
                    	        {
                    	        Object root_1 = (Object)adaptor.nil();
                    	        root_1 = (Object)adaptor.becomeRoot(
                    	        (Object)adaptor.create(MODIFIER, "MODIFIER")
                    	        ...
                    	        // Invenio.g:178:37: ^( FUZZY NUMBER[\"0.5\"] )
                    	        {
                    	        Object root_2 = (Object)adaptor.nil();
                    	        root_2 = (Object)adaptor.becomeRoot(
                    	        (Object)adaptor.create(FUZZY, "FUZZY")
                    ...
                    break;
                case 2 :
                    // Invenio.g:184:4: ( TILDE -> ^( MODIFIER ^( BOOST ) ^( FUZZY NUMBER[\"0.5\"] ) ) ) ( (~ ( WS | TILDE | CARAT ) )=>f= NUMBER -> ^( MODIFIER ^( BOOST ) ^( FUZZY ( $f)? ) ) )*
                    {
                    // Invenio.g:184:4: ( TILDE -> ^( MODIFIER ^( BOOST ) ^( FUZZY NUMBER[\"0.5\"] ) ) )
                    // Invenio.g:184:5: TILDE
                    {
                    TILDE62=(Token)match(input,TILDE,FOLLOW_TILDE_in_term_modifier1255); if (state.failed) return retval; 
                    ...
                    {
                        // Invenio.g:184:14: ^( MODIFIER ^( BOOST ) ^( FUZZY NUMBER[\"0.5\"] ) )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(MODIFIER, "MODIFIER")
                        ...
                        // Invenio.g:184:34: ^( FUZZY NUMBER[\"0.5\"] )
                        {
                        Object root_2 = (Object)adaptor.nil();
                        root_2 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(FUZZY, "FUZZY")
                    ...
                    // Invenio.g:185:4: ( (~ ( WS | TILDE | CARAT ) )=>f= NUMBER -> ^( MODIFIER ^( BOOST ) ^( FUZZY ( $f)? ) ) )*
                    loop28:
                    do {
                        int alt28=2;
                        ...
                        switch (alt28) {
                    	case 1 :
                    	    // Invenio.g:185:5: (~ ( WS | TILDE | CARAT ) )=>f= NUMBER
                    	    {
                    	    f=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_term_modifier1294); if (state.failed) return retval; 
                    	    if ( state.backtracking==0 ) stream_NUMBER.add(f);
                    	    ...
                    	    {
                    	        // Invenio.g:185:38: ^( MODIFIER ^( BOOST ) ^( FUZZY ( $f)? ) )
                    	        {
                    	        Object root_1 = (Object)adaptor.nil();
                    	        root_1 = (Object)adaptor.becomeRoot(
                    	        (Object)adaptor.create(MODIFIER, "MODIFIER")
    ...
    // $ANTLR start "boost"
    // Invenio.g:189:1: boost : CARAT NUMBER ;
    public final InvenioParser.boost_return boost() throws RecognitionException {
        ...
        try {
            // Invenio.g:189:7: ( CARAT NUMBER )
            // Invenio.g:190:2: CARAT NUMBER
            {
            root_0 = (Object)adaptor.nil();


            CARAT63=(Token)match(input,CARAT,FOLLOW_CARAT_in_boost1331); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            CARAT63_tree = 
            ...
            NUMBER64=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_boost1333); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            NUMBER64_tree = 
    ...
    // $ANTLR start "fuzzy"
    // Invenio.g:193:1: fuzzy : TILDE NUMBER ;
    public final InvenioParser.fuzzy_return fuzzy() throws RecognitionException {
        ...
        try {
            // Invenio.g:193:7: ( TILDE NUMBER )
            // Invenio.g:194:2: TILDE NUMBER
            {
            root_0 = (Object)adaptor.nil();


            TILDE65=(Token)match(input,TILDE,FOLLOW_TILDE_in_fuzzy1345); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            TILDE65_tree = 
            ...
            NUMBER66=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_fuzzy1347); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            NUMBER66_tree = 
    ...
    // $ANTLR start "near"
    // Invenio.g:198:1: near : ( NEAR -> ^( OPERATOR[\"NEAR 5\"] ) ) ( '/' b= NUMBER -> ^( OPERATOR[\"NEAR \" + $b.getText()] ) )? ;
    public final InvenioParser.near_return near() throws RecognitionException {
        ...
        try {
            // Invenio.g:198:6: ( ( NEAR -> ^( OPERATOR[\"NEAR 5\"] ) ) ( '/' b= NUMBER -> ^( OPERATOR[\"NEAR \" + $b.getText()] ) )? )
            // Invenio.g:199:2: ( NEAR -> ^( OPERATOR[\"NEAR 5\"] ) ) ( '/' b= NUMBER -> ^( OPERATOR[\"NEAR \" + $b.getText()] ) )?
            {
            // Invenio.g:199:2: ( NEAR -> ^( OPERATOR[\"NEAR 5\"] ) )
            // Invenio.g:199:3: NEAR
            {
            NEAR67=(Token)match(input,NEAR,FOLLOW_NEAR_in_near1361); if (state.failed) return retval; 
            ...
            {
                // Invenio.g:199:11: ^( OPERATOR[\"NEAR 5\"] )
                {
                Object root_1 = (Object)adaptor.nil();
                root_1 = (Object)adaptor.becomeRoot(
            ...
            // Invenio.g:200:2: ( '/' b= NUMBER -> ^( OPERATOR[\"NEAR \" + $b.getText()] ) )?
            int alt30=2;
            ...
            switch (alt30) {
                case 1 :
                    // Invenio.g:200:3: '/' b= NUMBER
                    {
                    char_literal68=(Token)match(input,52,FOLLOW_52_in_near1374); if (state.failed) return retval; 
                    if ( state.backtracking==0 ) stream_52.add(char_literal68);


                    b=(Token)match(input,NUMBER,FOLLOW_NUMBER_in_near1378); if (state.failed) return retval; 
                    if ( state.backtracking==0 ) stream_NUMBER.add(b);
                    ...
                    {
                        // Invenio.g:200:19: ^( OPERATOR[\"NEAR \" + $b.getText()] )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
    ...
    public final void synpred1_Invenio_fragment() throws RecognitionException {
        // Invenio.g:58:2: ( modifier LPAREN ( clauseDefault )+ RPAREN )
        // Invenio.g:58:3: modifier LPAREN ( clauseDefault )+ RPAREN
        {
        pushFollow(FOLLOW_modifier_in_synpred1_Invenio342);
        modifier();

        state._fsp--;
        if (state.failed) return ;

        match(input,LPAREN,FOLLOW_LPAREN_in_synpred1_Invenio344); if (state.failed) return ;

        // Invenio.g:58:19: ( clauseDefault )+
        int cnt31=0;
        loop31:
        do {
            int alt31=2;
            ...
            if ( ((LA31_0 >= LBRACK && LA31_0 <= LPAREN)||LA31_0==NUMBER||(LA31_0 >= PHRASE && LA31_0 <= PHRASE_ANYTHING)||(LA31_0 >= TERM_NORMAL && LA31_0 <= TERM_TRUNCATED)||LA31_0==51) ) {
                alt31=1;
            }
        	...
        	case 1 :
        	    // Invenio.g:58:19: clauseDefault
        	    {
        	    pushFollow(FOLLOW_clauseDefault_in_synpred1_Invenio346);
        	    clauseDefault();
        ...
        match(input,RPAREN,FOLLOW_RPAREN_in_synpred1_Invenio349); if (state.failed) return ;
    ...
    public final void synpred2_Invenio_fragment() throws RecognitionException {
        // Invenio.g:59:4: ( LPAREN ( clauseDefault )+ RPAREN CARAT NUMBER )
        // Invenio.g:59:5: LPAREN ( clauseDefault )+ RPAREN CARAT NUMBER
        {
        match(input,LPAREN,FOLLOW_LPAREN_in_synpred2_Invenio405); if (state.failed) return ;

        // Invenio.g:59:12: ( clauseDefault )+
        int cnt32=0;
        loop32:
        do {
            int alt32=2;
            ...
            if ( ((LA32_0 >= LBRACK && LA32_0 <= LPAREN)||LA32_0==NUMBER||(LA32_0 >= PHRASE && LA32_0 <= PHRASE_ANYTHING)||(LA32_0 >= TERM_NORMAL && LA32_0 <= TERM_TRUNCATED)||LA32_0==51) ) {
                alt32=1;
            }
        	...
        	case 1 :
        	    // Invenio.g:59:12: clauseDefault
        	    {
        	    pushFollow(FOLLOW_clauseDefault_in_synpred2_Invenio407);
        	    clauseDefault();
        ...
        match(input,RPAREN,FOLLOW_RPAREN_in_synpred2_Invenio410); if (state.failed) return ;

        match(input,CARAT,FOLLOW_CARAT_in_synpred2_Invenio412); if (state.failed) return ;

        match(input,NUMBER,FOLLOW_NUMBER_in_synpred2_Invenio414); if (state.failed) return ;
    ...
    public final void synpred3_Invenio_fragment() throws RecognitionException {
        // Invenio.g:60:4: ( LPAREN )
        // Invenio.g:60:5: LPAREN
        {
        match(input,LPAREN,FOLLOW_LPAREN_in_synpred3_Invenio469); if (state.failed) return ;
    ...
    public final void synpred4_Invenio_fragment() throws RecognitionException {
        // Invenio.g:177:3: ( TILDE NUMBER )
        // Invenio.g:177:4: TILDE NUMBER
        {
        match(input,TILDE,FOLLOW_TILDE_in_synpred4_Invenio1175); if (state.failed) return ;

        match(input,NUMBER,FOLLOW_NUMBER_in_synpred4_Invenio1177); if (state.failed) return ;
    ...
    // $ANTLR start synpred5_Invenio
    public final void synpred5_Invenio_fragment() throws RecognitionException {
        // Invenio.g:185:5: (~ ( WS | TILDE | CARAT ) )
        // Invenio.g:
        {
        if ( (input.LA(1) >= ADDED && input.LA(1) <= BOOST)||(input.LA(1) >= CLAUSE && input.LA(1) <= TERM_TRUNCATED)||(input.LA(1) >= TO && input.LA(1) <= VBAR)||(input.LA(1) >= 51 && input.LA(1) <= 52) ) {
            input.consume();
            state.errorRecovery=false;
            state.failed=false;
        }
    ...
    public final boolean synpred5_Invenio() {
        state.backtracking++;
        int start = input.mark();
        try {
            synpred5_Invenio_fragment(); // can never throw exception
        } catch (RecognitionException re) {
            System.err.println("impossible: "+re);
        }
        boolean success = !state.failed;
    ...
    public static final BitSet FOLLOW_clauseDefault_in_mainQ133 = new BitSet(new long[]{0x00083000320E0002L});
    public static final BitSet FOLLOW_clauseStrongest_in_clauseDefault166 = new BitSet(new long[]{0x0000000001000002L});
    public static final BitSet FOLLOW_NOT_in_clauseDefault175 = new BitSet(new long[]{0x00083000320E0000L});
    ...
    public static final BitSet FOLLOW_AND_in_clauseStrongest218 = new BitSet(new long[]{0x00083000320E0000L});
    ...
    public static final BitSet FOLLOW_OR_in_clauseStrong262 = new BitSet(new long[]{0x00083000320E0000L});
    ...
    public static final BitSet FOLLOW_near_in_clauseWeak306 = new BitSet(new long[]{0x00083000320E0000L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_primaryClause357 = new BitSet(new long[]{0x00083000320E0000L});
    public static final BitSet FOLLOW_clauseDefault_in_primaryClause359 = new BitSet(new long[]{0x00083200320E0000L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_primaryClause421 = new BitSet(new long[]{0x00083000320E0000L});
    public static final BitSet FOLLOW_clauseDefault_in_primaryClause423 = new BitSet(new long[]{0x00083200320E0000L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_primaryClause473 = new BitSet(new long[]{0x00083000320E0000L});
    public static final BitSet FOLLOW_clauseDefault_in_primaryClause475 = new BitSet(new long[]{0x00083200320E0000L});
    ...
    public static final BitSet FOLLOW_LPAREN_in_multi_value962 = new BitSet(new long[]{0x0008300032060000L});
    public static final BitSet FOLLOW_mterm_in_multi_value964 = new BitSet(new long[]{0x0008320032060000L});
    ...
    public static final BitSet FOLLOW_51_in_modifier1117 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CARAT_in_term_modifier1139 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_NUMBER_in_term_modifier1143 = new BitSet(new long[]{0x0000400000000002L});
    public static final BitSet FOLLOW_TILDE_in_term_modifier1181 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_NUMBER_in_term_modifier1185 = new BitSet(new long[]{0x0000400000000002L});
    public static final BitSet FOLLOW_TILDE_in_term_modifier1212 = new BitSet(new long[]{0x0000400000000002L});
    public static final BitSet FOLLOW_TILDE_in_term_modifier1255 = new BitSet(new long[]{0x0000000002000002L});
    public static final BitSet FOLLOW_NUMBER_in_term_modifier1294 = new BitSet(new long[]{0x0000000002000002L});
    public static final BitSet FOLLOW_CARAT_in_boost1331 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_NUMBER_in_boost1333 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_TILDE_in_fuzzy1345 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_NUMBER_in_fuzzy1347 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NEAR_in_near1361 = new BitSet(new long[]{0x0010000000000002L});
    public static final BitSet FOLLOW_52_in_near1374 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_NUMBER_in_near1378 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_modifier_in_synpred1_Invenio342 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_LPAREN_in_synpred1_Invenio344 = new BitSet(new long[]{0x00083000320E0000L});
    public static final BitSet FOLLOW_clauseDefault_in_synpred1_Invenio346 = new BitSet(new long[]{0x00083200320E0000L});
    public static final BitSet FOLLOW_RPAREN_in_synpred1_Invenio349 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LPAREN_in_synpred2_Invenio405 = new BitSet(new long[]{0x00083000320E0000L});
    public static final BitSet FOLLOW_clauseDefault_in_synpred2_Invenio407 = new BitSet(new long[]{0x00083200320E0000L});
    public static final BitSet FOLLOW_RPAREN_in_synpred2_Invenio410 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_CARAT_in_synpred2_Invenio412 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_NUMBER_in_synpred2_Invenio414 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LPAREN_in_synpred3_Invenio469 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_TILDE_in_synpred4_Invenio1175 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_NUMBER_in_synpred4_Invenio1177 = new BitSet(new long[]{0x0000000000000002L});
